#############################################################################
# Makefile for building: dev/deb/template/usr/local/bin/rfc4193
...
QMAKE_TARGET  = rfc4193
DISTDIR       = $(DEB)/usr/local/bin/
TARGET        = $(DEB)/usr/local/bin/rfc4193
...
####### Compile
rfc4193.o: src/rfc4193.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o rfc4193.o src/rfc4193.c
